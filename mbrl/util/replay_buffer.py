...
class ReplayBuffer:
    ...
    def __init__(
        ...
        self.timeout = np.empty(capacity, dtype=bool)
    ...
    def add_batch(
        ...
        def copy_from_to(buffer_start, batch_start, how_many):
            ...
            np.copyto(self.timeout[buffer_slice], timeout[batch_slice])
    ...
    def save(self, save_dir: Union[pathlib.Path, str]):
        ...
        np.savez(
            ...
            timeout=self.timeout[: self.num_stored],
    ...
    def load(self, load_dir: Union[pathlib.Path, str]):
        ...
        self.timeout[:num_stored] = data["timeout"]
