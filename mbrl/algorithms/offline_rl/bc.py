...
from .bc_util import compute_batched, discount_cumsum, sample_batch, torchify, traj_to_tuple_data
...
class BehaviorPretraining(nn.Module):
    ...
    def train(self, traj_data, n_steps, batch_size=256, log_freq=1000, log_fun=None):
        """ A basic trainer loop. Users can customize this method if needed.
